                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input required type="text" name="firstname" value="<?php echo isset($_GET['idedit']) ? $result['employee_name'] : ''; ?>" class="form-control" id="name" placeholder="Enter name">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="userid">Last Name</label>
                                                        <input required type="text" value="<?php echo isset($_GET['idedit']) ? $result['userid'] : ''; ?>" name="lastname" class="form-control" id="userid" placeholder="user id">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">

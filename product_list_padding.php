               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item ">
                                    <a href="product_list_padding.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Purchase Padding</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="#">Purchase</a></li>
                                <li class="breadcrumb-item active">Purchase Padding</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="card">
                            ...
                            <div class="card-body table-responsive p-0">
                                <table class="table  table-head-fixed text-nowrap">
                                    ...
                                    <tbody class="">
                                        <?php foreach ($invoicepadding as $Key => $val) { ?>
                                            <tr>
                                                ...
                                                <td class="align-middle"><?php $totalpay = $val['total_amount'] - $val['paid_amount'];
                                                                            echo number_format($totalpay, 2)  ?></td>
                                                <td class="align-middle"><span class="bg-danger disabled  px-2 py-1 rounded"><?= $val['status'] ?></span></td>
                                                <td class="align-middle"><a href="paypadding.php?paddingdetail=<?= $val['paymentID'] ?>"><button class="btn btn-primary">Detail</button></a></td>
                                            </tr>

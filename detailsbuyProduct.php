                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="card card-primary">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['firstname'] . " " . $paddingdetail['lastname'] : ''; ?>" class="form-control" id="name" placeholder="Enter name">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['email'] : ''; ?>" class="form-control" id="email" placeholder="Enter email">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="phone">Customer Phone</label>
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['tel'] : ''; ?>" class="form-control" id="phone" placeholder="Phone">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        <label for="dob"> Order Date</label>
                                                        <input type="date" value="<?php echo  isset($_GET['list_purchas']) ? date('Y-m-d', strtotime($paddingdetail['create_at'])) : ''; ?>" class="form-control" id="dob" placeholder="Enter email">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="phone">Order Invoice</label>
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? "VN-" . $paddingdetail['paymentID'] : ''; ?>" class="form-control" id="phone" placeholder="Phone">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['payment_method'] : ''; ?>" class="form-control" id="email" placeholder="Enter email">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                                        <label for="phone">Paid Amount</label>
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['paid_amount'] : ''; ?>" class="form-control" id="phone" placeholder="Phone">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <input type="text" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['total_amount'] - $paddingdetail['paid_amount'] : ''; ?>" class="form-control " id="phone" disabled placeholder="due money">
                                                        <input type="hidden" name="duemoney" value="<?php echo isset($_GET['list_purchas']) ? $paddingdetail['total_amount'] - $paddingdetail['paid_amount'] : ''; ?>">
                                                    </div>
                                                    <div class="form-group col-md-6">
                                        ...
                                        <div class="card-footer">
                                            <a href="employee_details.php?empdetails=<?= isset($_GET['list_purchas']) ? $paddingdetail['employee_id'] : ''; ?> ?>" class="btn btn-success">See Employee</a>
                                            <!-- <button type="submit" name="ordercancel" class="btn btn-danger">Cancel</button> -->
                                            <button type="submit" name="orderbackdetail" class="btn btn-secondary">back</button>
                                        </div>

                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title d-flex align-items-center p-0 m-0 ">
                                        ...
                                        <select name="row" id="row" class="custom-select-sm m-0 p-0 col-md-12">
                                            <option value="5" <?= ($rowlist == 5) ? 'selected' : '' ?>>5</option>
                                            <option value="10" <?= ($rowlist == 10) ? 'selected' : '' ?>>10</option>
                                            <option value="15" <?= ($rowlist == 15) ? 'selected' : '' ?>>15</option>
                                            <option value="20" <?= ($rowlist == 20) ? 'selected' : '' ?>>20</option>
                                        </select>
                                ...
                                <div class="card-body table-responsive p-0">
                                    <table class="table  table-head-fixed text-nowrap">
                                        ...
                                        <tbody class="showlistsearch" id="output">
                                            <?php foreach ($listemp as $key => $val) { ?>
                                                <tr>
                                                    <td><?php
                                                        if (isset($_GET['pageemployee']) && $_GET['pageemployee'] > 1)
                                                            echo (($_GET['pageemployee'] - 1) * 10) + $key + 1;
                                                        else
                                                            echo $key + 1;
                                                        ?></td>
                                                    <td>
                                                    ...
                                                    <td class="align-middle"><i data-listdelete="<?php echo $val['id'] ?>" class="fa-solid p-1 iconhover fa-trash pointer icondelete"></i>
                                                        <a href="addemployeephp.php?idedit=<?php echo $val['id'] ?>"><i class="fa-solid p-1 iconhover fa-pencil"></i></a>
                                            ...
                                            <ul class="pagination pagination-sm float-right">
                                                ...
                                                <?php for ($i = 1; $i <= $maxpage; $i++) { ?>
                                                    <li class="page-item <?php
                                                                            ...
                                                                            ?>
                                                    "><a class="page-link" href="listemployee.php?pageemployee=<?= $i ?>"><?= $i ?></a></li>
                                                <?php } ?>
...
<script>
    $(document).ready(function() {
        $(".listsearch").keyup(function() {
            ...
            $.ajax({
                method: 'post',
                url: 'isset/listsearch.php',
                data: {
                    search: search
                },
                success: function(response) {
                    $(".showlistsearch").html(response);
                    // alert(search);
                }
            })
        })
